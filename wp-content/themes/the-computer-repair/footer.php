        ...
        <div id="footer-2">
          	<div class="copyright container">
                ...
                <?php if( get_theme_mod( 'the_computer_repair_hide_show_scroll',true) != '') { ?>
                    ...
                    if($theme_lay == 'Left'){ ?>
                      <a href="#" class="scrollup left"><i class="fas fa-long-arrow-alt-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'the-computer-repair' ); ?></span></a>
                    <?php }else if($theme_lay == 'Center'){ ?>
                      <a href="#" class="scrollup center"><i class="fas fa-long-arrow-alt-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'the-computer-repair' ); ?></span></a>
                    <?php }else{ ?>
                      <a href="#" class="scrollup"><i class="fas fa-long-arrow-alt-up"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'the-computer-repair' ); ?></span></a>
                    <?php }?>
                <?php }?>    
          	</div>
          	<div class="clear"></div>
